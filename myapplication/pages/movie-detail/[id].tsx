                ...
                <Stack direction="column" spacing={2}>
                    <Box sx={{ display: 'flex', flexDirection: 'row' }}>
                        ...
                        <Box>
                            <Typography variant="body1" sx={{ color: 'white' }}>
                                <StarBorderIcon sx={{ fontSize: 30, color: 'orange' }} /> {data.vote_average}
                            </Typography>
                        </Box>
                    </Box>
                    ...
                    <Stack direction="column" spacing={1} alignItems="center">
                        <Stack direction="row" alignItems="center" spacing={1}>
                            ...
                            <AccessTimeIcon sx={{ color: 'white', marginLeft: '10px', marginRight: '5px' }} />
                            <Typography variant="body1" sx={{ color: 'white' }}>
                                {data.runtime} Minutes
                            </Typography>
                            <ConfirmationNumberIcon sx={{ color: 'white', marginLeft: '10px', marginRight: '5px' }} />
                            <Typography variant="body1" sx={{ color: 'white' }}>
                                {data.genres[0]?.name}
                            </Typography>
                        </Stack>
